...
export default function modifyPackageJson(userEnginePath) {
  ...
  const exportsPath = path.join(userEngineScriptsPath, 'exports.json'); // add named exports here instead of in package.json !
  const devDependenciesPath = path.join(userEngineScriptsPath, 'devDependencies.json'); // add devDependencies here instead of in package.json !
